...
def g_img_1(input_text:str):
    ...
    def parse():
        ...
        # Basic
        vq_parser.add_argument("-aug",  "--augments", nargs='+', action='append', type=str, choices=['Hf','Ji','Sh','Pe','Ro','Af','Et','Ts','Er'], help="Enabled augments (latest vut method only)", default=[['Hf','Af', 'Pe', 'Ji', 'Er']], dest='augments')
        ...
        vq_parser.add_argument("-o",    "--output", type=str, help="Output filename", default="MyCode/Web_Design/static/img/output.png", dest='output')
        vq_parser.add_argument("-se",   "--save_every", type=int, help="Save image iterations", default=50, dest='display_freq')
        vq_parser.add_argument("-sd",   "--seed", type=int, help="Seed", default=42, dest='seed')

        # Input Text
        vq_parser.add_argument("-p",    "--prompts", type=str, help="Text prompts", default=None, dest='prompts')
        
        # Model
        vq_parser.add_argument("-ckpt", "--vqgan_checkpoint", type=str, help="VQGAN checkpoint", default=f'MyCode/Web_Design/checkpoints/imagenet.ckpt', dest='vqgan_checkpoint')
        vq_parser.add_argument("-conf", "--vqgan_config", type=str, help="VQGAN config", default=f'MyCode/Web_Design/checkpoints/imagenet.yaml', dest='vqgan_config')

        # Cut
        vq_parser.add_argument("-cpe",  "--change_prompt_every", type=int, help="Prompt change frequency", default=0, dest='prompt_frequency')
        vq_parser.add_argument("-cutm", "--cut_method", type=str, help="Cut method", choices=['original','latest'], default='latest', dest='cut_method')
        vq_parser.add_argument("-cutp", "--cut_power", type=float, help="Cut power", default=1., dest='cut_pow')
        vq_parser.add_argument("-cuts", "--num_cuts", type=int, help="Number of cuts", default=64, dest='cutn')

        # Interation
        vq_parser.add_argument("-i",    "--iterations", type=int, help="Number of iterations", default=150, dest='max_iterations')
        ...
        vq_parser.add_argument("-lr",   "--learning_rate", type=float, help="Learning rate", default=0.16, dest='step_size')
        ...
        args.prompts = input_text
        args.output = "MyCode/Web_Design/static/img/" + input_text + ".png"
